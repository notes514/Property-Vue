...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.guet.property.controller..*.*(..))")
    public void webLog() {
    }
    ...
    public void afterReturning(Object result) {
        ...
        if (map != null) {
            ...
            jsonObject.put("took", System.currentTimeMillis() - Long.parseLong(map.getOrDefault("startTime",
